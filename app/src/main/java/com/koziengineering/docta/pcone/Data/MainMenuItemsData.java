package com.koziengineering.docta.pcone.Data;

import android.content.res.Resources;

import com.koziengineering.docta.pcone.Objects.MenuItem;
...
public class MainMenuItemsData {
...

    {
        ...
        menuItems.add(new MenuItem(R.drawable.le, res.getString(R.string.menu_cands),MAIN_MENU_LIST_ELEC, res.getString(R.string.sub_menu_cands) ));
        ...
        menuItems.add(new MenuItem(R.drawable.cands, res.getString(R.string.menu_list_cands),MAIN_MENU_CANDS, res.getString(R.string.sub_menu_list_cands) ));
