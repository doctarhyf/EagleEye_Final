...
public class CandidatesData {
    ...
    public static Candidate getWinningCandidate(Context context, int candType, int candId){

        List<Candidate> candidates = getCandidates(context, candType);

        return candidates.get(candId);
    }
}
